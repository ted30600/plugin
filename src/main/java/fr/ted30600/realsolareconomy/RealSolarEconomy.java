...
public final class RealSolarEconomy extends JavaPlugin implements Listener, CommandExecutor, TabCompleter {
    ...
    private record TradeRequest(UUID from,long expires) {}
}
